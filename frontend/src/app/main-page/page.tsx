...
<>
<main>
<div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 border-4 border-red-500">
...
<div className="item align-left border-3 border-amber-500 mr-auto p-5"> 
   <p className="text-xl text-gray-600 font-bold"> Database </p>
</div>
</main>
